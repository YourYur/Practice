...
extension UserInfo {
    ...
    static var friendInfo: [UserInfo] = [
        ...
        UserInfo(profileImage: nil , userName: "얄랴얄랴얄랴셩얄라리얄라", StatusMessage: nil, profileMusic: nil),
        ...
        UserInfo(profileImage: UIImage(named: "person03"), userName: "강소연", StatusMessage: nil, profileMusic: nil),
        UserInfo(profileImage: nil , userName: "얄랴얄랴얄랴셩얄라리얄라얄랴얄랴얄랴셩얄라리얄라", StatusMessage: nil, profileMusic: nil),
